...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Because this multiple least squares regression has more than two explanatory variables, there isn't a way to show the regression line in a two or three dimensional space. As a result, I've shown a pairwise scatterplot below that demonstrates all of the possible two dimensional scatterplots that could have been constructed from the dataset. In addition, I've attached coefficient estimates of these simple least squares regression model.
